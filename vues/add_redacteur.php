<?php
    $url = "http://127.0.0.1:8001/blog/addnewredacteur";
    $data = array(
        'nom' => $_POST['nom'],
        'prenom' => $_POST['prenom'],
        'email' => $_POST['email']
...
<body>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="email" name="email" placeholder="Veuillez saisir un adresse e-mail">
        </div>
